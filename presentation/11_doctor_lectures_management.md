...
الدكتور لما بيسجل دخوله للوحة، بتظهرله **الصفحة الرئيسية (Homepage)**. ودي شاشة بتعرضله أرقام وإحصائيات سريعة ومهمة تهمه أول ما يبدأ يومه: عدد محاضراته لليوم، إجمالي المواد اللي بيدرسها، ومتوسط نسبة الحضور العامة في كل كورساته.
...
* **ماذا تشرح (التدفق التقني)**:
  1. تشرح للجنة أن الضغط على زر البدء يرسل طلباً للخادم لتغيير حالة المحاضرة إلى جارية (`status = in-progress`) وتسجيل توقيت البداية الفعلي.
  2. توضح أن الكود يبحث فوراً عن الطلبة الذين اتصلت هواتفهم مسبقاً براوتر القاعة (Active Student Sessions) ويقوم بتحضيرهم تلقائياً (Auto-Start Attendance) لتسريع التحضير.
